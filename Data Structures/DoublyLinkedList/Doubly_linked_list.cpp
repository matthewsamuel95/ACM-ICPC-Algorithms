...
#include<cstdlib>
using namespace std;
//creating the basic node with 2 pointer where next stores address of next node and prev stores address of previous node
struct node
{
    int info;
    struct node *next;
...
//function for inserting node at a fixed postion if it exist
